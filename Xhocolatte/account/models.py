...
class Customer(AbstractBaseUser, PermissionsMixin):
    ...
    mobile = models.CharField(max_length=9, blank=True)
...
class Address(models.Model):
    ...
    phone = models.CharField(_("Teléfono"), max_length=9)
    postcode = models.CharField(_("Código Postal"), max_length=5)
    address_line = models.CharField(_("Dirección 1"), max_length=255)
    address_line2 = models.CharField(_("Dirección 2"), max_length=255)
